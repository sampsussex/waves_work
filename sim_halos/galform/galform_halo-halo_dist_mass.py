                ...
                if len(r_filt) > 10:
                    ...
                    for i in range(len(r_filt)):
                        if 0 <= xi[i] < 50 and 0 <= yi[i] < 50:
                            #num_count_sum[yi[i], xi[i]] += 1
                            count[yi[i], xi[i]] += 1
                    
                    # Calculate average mass
                    #num_count = np.zeros_like(num_count_sum)
                    # nonzero = count > 0
                    ...
                    # Plot average mass heat map with viridis cmap
...
if __name__ == "__main__":
    ...
    halo_file_path = '/Users/sp624AA/Downloads/mocks/GALFORM/G3CMockGalv04.fits'
